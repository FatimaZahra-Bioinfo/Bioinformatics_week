...
The original dataset had 39 samples. After clustering and applying a cutHeight of 300,000, the analysis kept 26 samples. So, 13 samples were discarded.
...
Before merging, the co-expression modules established were 40 modules, and after merging, they became 36 merged modules.
...
According to the heatmap below, the violet module (MEviolet) has the highest positive correlation with the "blwgrd (below ground biomass)" trait with a correlation value of 0.66 and a highly significant p-value of (3e−04).
